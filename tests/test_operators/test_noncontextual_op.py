...
from symmer.operators import NoncontextualOp, PauliwordOp, QuantumState
...
def jordan_generator_reconstruction_check(self, generators):
    ...
    for P in Anticommuting:
        PwordOp_noncon += PwordOp_remain[
            PwordOp_remain.generator_reconstruction(P + Symmetries)[1]
        ]
...
def test_from_hamiltonian_diag():
    ...
    H = PauliwordOp.from_dictionary(H_con_dict)
    H_noncon_diag = NoncontextualOp.from_hamiltonian(
        H, strategy="diag", generators=None, DFS_runtime=10
    )
    assert np.all(
        np.sum(H_noncon_diag.X_block, axis=1) == 0
    ), "some non Z operators present"
...
def test_from_hamiltonian_DFS_magnitude():
    ...
    """
    H = PauliwordOp.from_dictionary(H_con_dict)
    H_noncon_dfs = NoncontextualOp.from_hamiltonian(
        H, strategy="DFS_magnitude", generators=None, DFS_runtime=10
    )
...
def test_from_hamiltonian_DFS_largest():
    ...
    H = PauliwordOp.from_dictionary(H_con_dict)
    H_noncon_dfs = NoncontextualOp.from_hamiltonian(
        H, strategy="DFS_largest", generators=None, DFS_runtime=10
    )
...
def test_from_hamiltonian_SingleSweep_magnitude():
    ...
    H = PauliwordOp.from_dictionary(H_con_dict)
    H_noncon_dfs = NoncontextualOp.from_hamiltonian(
        H, strategy="SingleSweep_magnitude", generators=None, DFS_runtime=10
    )
...
def test_from_hamiltonian_SingleSweep_random():
    ...
    H = PauliwordOp.from_dictionary(H_con_dict)
    H_noncon_dfs = NoncontextualOp.from_hamiltonian(
        H, strategy="SingleSweep_random", generators=None, DFS_runtime=10
    )
...
def test_from_hamiltonian_SingleSweep_CurrentOrder():
    ...
    H = PauliwordOp.from_dictionary(H_con_dict)
    H_noncon_dfs = NoncontextualOp.from_hamiltonian(
        H, strategy="SingleSweep_CurrentOrder", generators=None, DFS_runtime=10
    )
...
def test_from_hamiltonian_generators():
    ...
    generators1 = PauliwordOp.from_dictionary({"IZ": (1 + 0j), "ZI": (1 + 0j)})
    H = PauliwordOp.from_dictionary(H_con_dict)

    H_noncon_generators1 = NoncontextualOp.from_hamiltonian(
        H, strategy="generators", generators=generators1, DFS_runtime=10
    )

    assert H_noncon_generators1.is_noncontextual

    ## NON-COMMUTING generators
    generators2 = PauliwordOp.from_dictionary(
        {"IZ": (1 + 0j), "ZI": (1 + 0j), "XI": (1 + 0j)}
    )

    H_noncon_generators2 = NoncontextualOp.from_hamiltonian(
        H, strategy="generators", generators=generators2, DFS_runtime=10
    )
...
def test_noncon_noncommuting_Z2():
    ...
    """
    H_noncon = PauliwordOp.from_dictionary(
        {
            "IIIIIIIIII": (-15.27681058613343 + 0j),
            "IIIIIIIIIZ": (-0.2172743037258172 + 0j),
            "IIIIIZIIII": (0.11405708903311647 + 0j),
            "IIIIIZIIIZ": (0.22929933946046854 + 0j),
            "IIIIZIIIII": (0.07618739164001126 + 0j),
            "IIIIZIIIIZ": (0.10424432000703249 + 0j),
            "IIIIZZIIII": (0.2458433632534619 + 0j),
            "IIIZIIIIII": (0.07618739164001137 + 0j),
            "IIIZIIIIIZ": (0.11790253563113795 + 0j),
            "IIIZIZIIII": (0.2458433632534619 + 0j),
            "IIIZZIIIII": (0.14846395230159326 + 0j),
            "IIZIIIIIII": (0.17066279019288416 + 0j),
            "IIZIIIIIIZ": (0.19577211156187402 + 0j),
            "IIZIIZIIII": (0.220702612028004 + 0j),
            "IIZIZIIIII": (0.10245792602520705 + 0j),
            "IIZZIIIIII": (0.10964094999478652 + 0j),
            "IZIIIIIIII": (0.2601827946303151 + 0j),
            "IZIIIIIIIZ": (0.1060269619647709 + 0j),
            "IZIIIZIIII": (0.21982388480817722 + 0j),
            "IZIIZIIIII": (0.09485326000745692 + 0j),
            "IZIZIIIIII": (0.1112840228980842 + 0j),
            "IZZIIIIIII": (0.08389584977571822 + 0j),
            "IZZIZZIIIZ": (-0.14917151435431195 + 0j),
            "ZIIIIIIIII": (0.2601827946303149 + 0j),
            "ZIIIIIIIIZ": (0.11944056365665429 + 0j),
            "ZIIIIZIIII": (0.21982388480817722 + 0j),
            "ZIIIZIIIII": (0.1112840228980842 + 0j),
            "ZIIZIIIIII": (0.09485326000745692 + 0j),
            "ZIZIIIIIII": (0.12042746433351019 + 0j),
            "ZIZZIZIIIZ": (-0.14917151435431195 + 0j),
            "ZZIIIIIIII": (0.12244309127472158 + 0j),
            "IIZZZIXIXZ": (-0.0023524442663984376 + 0j),
            "ZIZIZZXIXZ": (0.0023524442663984376 + 0j),
            "ZIYIZZIXIY": (0.0023524442663984376 + 0j),
            "ZZYIIIIXIY": (-0.0023524442663984376 + 0j),
        }
    )
...
def test_solve_brute_force_discrete_no_ref():
    ...
    H_noncon.solve(strategy="brute_force", ref_state=None, num_anneals=None)
...
def test_solve_binary_relaxation_no_ref():
    ...
    H_noncon.solve(strategy="binary_relaxation", ref_state=None, num_anneals=None)
...
def test_solve_brute_force_PUSO_discrete_no_ref():
    ...
    H_noncon.solve(strategy="brute_force_PUSO", ref_state=None, num_anneals=None)
    assert np.isclose(H_noncon.energy, noncon_problem["E"])
...
def test_solve_brute_force_QUSO_discrete_no_ref():
    ...
    H_noncon.solve(strategy="brute_force_QUSO", ref_state=None, num_anneals=None)
    assert np.isclose(H_noncon.energy, noncon_problem["E"])
...
def test_solve_annealing_PUSO_discrete_no_ref():
    ...
    H_noncon.solve(strategy="annealing_PUSO", ref_state=None, num_anneals=1_000)
    assert np.isclose(H_noncon.energy, noncon_problem["E"])
...
def test_solve_annealing_QUSO_discrete_no_ref():
    ...
    H_noncon.solve(strategy="annealing_QUSO", ref_state=None, num_anneals=1_000)
    assert np.isclose(H_noncon.energy, noncon_problem["E"])
...
def test_solve_full_reference_state():
    ...
    H_noncon.solve(strategy="brute_force", ref_state=reference, num_anneals=None)
    assert np.isclose(H_noncon.energy, noncon_problem["E"])
...
def test_solve_brute_force_discrete_partial_ref():
    ...
    with pytest.warns():
        ...
        H_noncon.solve(
            strategy="brute_force", ref_state=partial_reference_state, num_anneals=None
        )
    assert np.isclose(H_noncon.energy, noncon_problem["E"])
